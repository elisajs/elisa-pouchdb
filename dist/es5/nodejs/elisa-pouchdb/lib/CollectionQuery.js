...
var dbEngine = new _DbEngine2.default();var _class = function (_CollectionQuery) {_inherits(_class, _CollectionQuery);function _class() {_classCallCheck(this, _class);return _possibleConstructorReturn(this, Object.getPrototypeOf(_class).apply(this, arguments));}_createClass(_class, [{ key: "_run", value: function _run(
    ...
    runNoIndex, value: function value(opts, callback) {
